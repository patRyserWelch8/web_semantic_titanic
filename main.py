...
passenger_graph : Graph = pl.transform_passengers_to_rdfs(passengers)
#print(passenger_graph.serialize(format='turtle'))
passenger_graph.serialize(destination='titanic.xml', format='pretty-xml')
